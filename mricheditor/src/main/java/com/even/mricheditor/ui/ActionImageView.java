...
public class ActionImageView extends AppCompatImageView {
    ...
    private RichEditor mRichEditorAction;
    ...
    public RichEditor getRichEditorAction() {
        return mRichEditorAction;
    }

    public void setRichEditorAction(RichEditor mRichEditorAction) {
    ...
    public void command() {
        //TODO RichEditor can not be null
